...
SRCREV_kura = "0d50f11782caf39c01249ea4ed4535323cb2762c"
...
USERADD_PACKAGES = "${PN}"
USERADD_PARAM_${PN} = " \
    --no-create-home --password '' --shell /sbin/nologin --user-group kura; \
    --system --user-group --password '' --groups dialout --user-group kurad; \
"
USERMOD_PARAM_${PN} = " \
    --lock kurad \
"
...
do_install () {
    ...
    ln -s ${KURA_VERSION_PATH} ${D}/opt/eclipse/kura_${KURA_VERSION}-SNAPSHOT_raspberry-pi-2
...
FILES_${PN} = " \
  ...
  /opt/eclipse \
  /opt/eclipse/kura \
  /opt/eclipse/kura_5.0.0-SNAPSHOT_raspberry-pi-2 \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/data/packages/LogConfigurationService.dp \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.localization_1.0.400.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/tinyb_1.0.300.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.servicemix.bundles.spring-expression_4.3.14.RELEASE_1.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.equinox.coordinator_1.3.800.v20200422-1833.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.camel.camel-stream_2.21.1.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.core.deployment_1.1.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.core.net_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.wire.component.conditional.provider_1.0.200.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.camel.camel-core_2.21.1.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/jdk.dio.aarch64_1.0.500.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.servicemix.bundles.spring-tx_4.3.14.RELEASE_1.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.equinox.http.jetty_3.7.400.v20200123-1333.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.jetty.servlet_9.4.35.v20201120.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.misc.cloudcat_1.0.300.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.asset.cloudlet.provider_1.0.500-SNAPSHOT.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.sun.misc_1.0.400.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.core.runtime_3.19.0.v20200724-1004.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.broker.artemis.core_1.1.100.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.useradmin.store_1.0.0-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.jetty.continuation_9.4.35.v20201120.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.jetty.security_9.4.35.v20201120.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.usb_1.0.500.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.broker.artemis.simple.mqtt_1.0.300.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.usb4java_1.2.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/com.google.protobuf_3.8.0.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.position_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.sysv.provider_1.0.200-SNAPSHOT.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.jetty.server_9.4.35.v20201120.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.qpid.proton-j_0.26.0.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.cloudconnection.eclipseiot.mqtt.provider_1.0.200-SNAPSHOT.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.ble.eddystone.provider_1.0.300.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/io.netty.codec_4.1.34.Final.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.core.crypto_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/io.netty.handler_4.1.34.Final.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.activemq.artemis_2.6.0.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.camel.camel-script_2.21.1.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/com.codeminders.hidapi_1.1.500.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.util_1.1.200-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.bluetooth_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/io.netty.transport_4.1.34.Final.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/com.codeminders.hidapi.armv6hf_1.1.500.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.jetty.io_9.4.35.v20201120.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/usb4java-javax_1.2.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.equinox.useradmin_1.2.0.v20200807-1148.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.servicemix.bundles.spring-beans_4.3.14.RELEASE_1.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.camel.camel-jms_2.21.1.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.jetty.customizer_1.0.200-SNAPSHOT.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.wire.provider_1.0.500-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.felix.useradmin_1.0.4.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.wire.camel_1.0.100.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.core_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.gpio_1.0.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.core.comm_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.wire.component.join.provider_1.0.200.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.camel.sun.misc_1.0.400.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.jetty.util.ajax_9.4.35.v20201120.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.core.cloud_1.1.500-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/jakarta.xml.soap-api_1.4.2.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.command_1.0.400.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.net_2.0.0-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.wire.h2db.component.provider_1.0.400-SNAPSHOT.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/jdk.dio_1.0.500.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.usb.armv6hf_1.0.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.core.status_1.0.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.equinox.http.registry_1.2.0.v20200614-1851.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.camel.camel-amqp_2.21.1.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.soda.dk.comm.aarch64_1.2.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.camel_1.3.100.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.geronimo.specs.geronimo-jms_2.0_spec_1.0.0.alpha-2.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.soda.dk.comm.armv6hf_1.2.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.equinox.metatype_1.5.300.v20200422-1833.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.core.configuration_2.0.300-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.osgi.util_3.5.300.v20190708-1141.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.soda.dk.comm.x86_64_1.2.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.asset.helper.provider_1.0.400.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.ble.ibeacon.provider_1.0.300.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/javax.el_2.2.0.v201303151357.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.api_2.2.0-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/io.netty.common_4.1.34.Final.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.hook.file.move.provider_1.0.300.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.logging.log4j.api_2.8.2.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.soda.dk.comm_1.2.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.web2_2.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/com.gwt.user_1.1.100.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.driver.helper.provider_1.0.400.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.servicemix.bundles.spring-core_4.3.14.RELEASE_1.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/jdk.dio.armv6hf_1.0.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.net.admin_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.equinox.region_1.5.0.v20200807-1629.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.wire.component.provider_1.0.500-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.xml.marshaller.unmarshaller.provider_1.0.200.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.debian.provider_1.0.200-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/com.codeminders.hidapi.aarch64_1.1.500.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.cloudconnection.raw.mqtt.provider_1.0.0-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.equinox.ds_1.6.200.v20200422-1833.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.servicemix.bundles.spring-jms_4.3.14.RELEASE_1.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/com.google.guava_25.0.0.jre.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.camel.camel-core-osgi_2.21.1.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.servicemix.bundles.spring-context_4.3.14.RELEASE_1.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.localization.resources_1.0.400.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/io.netty.resolver_4.1.34.Final.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.broker.artemis.xml_1.0.300.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.http.server.manager_1.0.0-SNAPSHOT.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.rest.provider_1.1.0-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.rest.asset.provider_1.0.400-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.clock_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.camel.xml_1.1.100.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/tinyb.armv6hf_1.0.300.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/com.codeminders.hidapi.x86_64_1.1.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.jetty.util_9.4.35.v20201120.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.equinox.wireadmin_1.0.800.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/jdk.dio.x86_64_1.0.500.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.wire.helper.provider_1.0.400.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.core.certificates_1.0.600-SNAPSHOT.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.linux.watchdog_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.ble.provider_1.0.400-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.deployment.agent_1.0.600-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.camel.cloud.factory_1.1.400.jar \
  ...
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.asset.provider_2.0.200.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.kura.json.marshaller.unmarshaller.provider_1.0.300-SNAPSHOT.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/javax.servlet_3.1.0.v201410161800.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.apache.qpid.jms.client_0.31.0.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/com.google.gson_2.7.0.v20170129-0911.jar \
  /opt/eclipse/kura_5.0.0_solid_sense/plugins/org.eclipse.jetty.http_9.4.35.v20201120.jar \
